...
class ProfilView(APIView):
    ...
    def get(self, request, user_uuid=None):
        try:
            ...
            if player is not None:
                ...
                #     (Q(player1=player, winner=None) | Q(player2=player, winner=None)) & ~Q(winner=player) & Q(status__in=[3])
                # ).count()
                match_loses = Match.objects.filter(
                    Q(status=3),
            ...
            return Response({"error": "Couldn't get user"}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def post(self, request, user_uuid=None):
        try:
            ...
            return Response({"error": "Couldn't update user"}, status=status.HTTP_400_BAD_REQUEST)
...
class SearchUserView(APIView):
    ...
    def get(self, request):
        try:
            ...
            return Response({"error": "Couldn't search users"}, status=status.HTTP_400_BAD_REQUEST)
...
class RelationView(APIView):
    ...
    def get(self, request):
        try:
            ...
            return Response({"error": "Couldn't get relations"}, status=status.HTTP_400_BAD_REQUEST)
    def post(self, request):
        try:
            ...
            return Response({"error": "Couldn't create relation"}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def put(self, request):
        try:
            ...
            return Response({"error": "Couldn't update relation"}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def delete(self, request):
        try:
            ...
            return Response({"error": "Couldn't delete relation"}, status=status.HTTP_400_BAD_REQUEST)
...
class ProfilMatchView(APIView):
    ...
    def get(self, request, user_uuid=None):
        try:
            ...
            return Response({"error": "Couldn't get matches"}, status=status.HTTP_400_BAD_REQUEST)
...
class ProfilTournamentView(APIView):
    ...
    def get(self, request, user_uuid=None):
        try:
            ...
            return Response({"error": "Couldn't get tournaments"}, status=status.HTTP_400_BAD_REQUEST)
